  ...
  return (
    ...
    >
      ...
      <div className={"flex flex-col items-center justify-between p-2 h-full"}>
        <div className={"md:text-4xl text-2xl font-medium"}>New Game</div>
        <div className={"flex flex-col text-center"}>
          <div className={"md:text-xl"}>Are you sure you want to reset the game?</div>
          <div className={"md:text-xl"}>This will count as a loss on your stats.</div>
        </div>
        <div className={"flex justify-evenly w-full p-2"}>
          <button
            onClick={() => {resetGame(); closeModal();}}
            className={"md:text-2xl text-xl text-black font-bold hover:bg-red-500 " +
